...
class ConfigurationManager : IConfigurationManager {
    ...
    private fun findConfiguration(source: BluePrintConfigurationSource): ConfigurationStructure? {
    ...
    fun init(configurationSourceList: Array<BluePrintConfigurationSource>) {
        configurationSourceList.forEach {
            list.add(ConfigurationStructure(it))
        }
    }

    private fun add(source: BluePrintConfigurationSource) {
