...
import com.tang.vscode.BluePrintConfigurationSource
import java.io.File
...
data class SourceRoot(
        ...
        val jsonSource: BluePrintConfigurationSource
): ISourceRoot {
    ...
    companion object {
        fun readFrom(reader: JsonReader, jsonSource: BluePrintConfigurationSource): SourceRoot? {
            var dir: String? = null
...
class ConfigurationStructure(val source: BluePrintConfigurationSource) : IConfigurationStructure {
